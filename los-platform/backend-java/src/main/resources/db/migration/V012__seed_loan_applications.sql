-- Flyway Migration: V012__seed_loan_applications.sql
-- LOS Platform — Seed: Loan Applications (loan.loan_applications)
-- 15 applications across all lifecycle stages

INSERT INTO loan.loan_applications (
    ...
    user_id, requested_amount, dsa_code, dsa_name,
  ...
  (
    ...
    '{"fullName":"Vikram Singh","dob":"1990-05-15","gender":"M","email":"vikram@example.com","pincode":"560001","state":"KA"}',
    ...
    'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 300000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Anita Desai","dob":"1988-03-22","gender":"F","email":"anita@example.com","pincode":"560002","state":"KA"}',
    ...
    'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 500000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Rajesh Kumar","dob":"1985-08-10","gender":"M","email":"rajesh@example.com","pincode":"560003","state":"KA"}',
    ...
    'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 2500000,
  ...
  (
    ...
    '{"fullName":"Meera Nair","dob":"1992-01-18","gender":"F","email":"meera@example.com","pincode":"560004","state":"KA"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 1500000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Suresh Patel","dob":"1980-11-30","gender":"M","email":"suresh@example.com","pincode":"560005","state":"KA"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 800000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Lakshmi Devi","dob":"1987-06-25","gender":"F","email":"lakshmi@example.com","pincode":"560006","state":"KA"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 3200000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Ganesh Enterprises","dob":"2015-04-01","gender":"M","email":"ganesh@example.com","pincode":"560007","state":"KA","entityType":"PARTNERSHIP"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 5000000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Harish Iyer","dob":"1993-09-14","gender":"M","email":"harish@example.com","pincode":"560008","state":"KA"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 400000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Divya Krishnan","dob":"2001-02-28","gender":"F","email":"divya@example.com","pincode":"560009","state":"KA"}',
  ...
  (
    ...
    '{"fullName":"Karthik Raja","dob":"1989-12-05","gender":"M","email":"karthik@example.com","pincode":"560010","state":"KA"}',
    ...
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 250000,
  ...
  (
    ...
    '{"encrypted":true,"last4":"1111"}',
    '{"fullName":"Nisha Menon","dob":"1995-07-20","gender":"F","email":"nisha@example.com","pincode":"560011","state":"KA"}',
    ...
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 40000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Prakash Reddy","dob":"1982-04-12","gender":"M","email":"prakash@example.com","pincode":"560012","state":"KA"}',
    ...
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 4500000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Sunita Rao","dob":"1991-10-08","gender":"F","email":"sunita@example.com","pincode":"560013","state":"KA"}',
    ...
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 850000,
    NULL, NULL,
  ...
  (
    ...
    '{"fullName":"Arun Kumar","dob":"1988-01-15","gender":"M","email":"arun@example.com","pincode":"560014","state":"KA"}',
    ...
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 200000,
  ...
  (
    ...
    '{"fullName":"Madhav Bhat","dob":"1986-03-30","gender":"M","email":"madhav@example.com","pincode":"560015","state":"KA"}',
    ...
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 150000,
    NULL, NULL,
    NOW() - INTERVAL '90 days', NOW() - INTERVAL '30 days'
  )
ON CONFLICT (application_number) DO NOTHING;

-- Update sanction details for sanctioned/approved apps
...
UPDATE loan.loan_applications
SET disbursed_at = NOW() - INTERVAL '25 days'
...
INSERT INTO loan.application_stage_history (
    id, application_id, from_status, to_status,
    action_by, action_by_role, remarks, timestamp
) VALUES
  (
    gen_random_uuid(), '88888888-8888-8888-8888-888888888888',
    'CREDIT_COMMITTEE', 'APPROVED',
    'b1ffcd00-0d1c-5fa9-cc7e-7cc0ce491b22', 'CREDIT_ANALYST',
  ...
  (
    ...
    'APPROVED', 'SANCTIONED',
    'c2aade11-1e2d-6aa0-dd8f-8dd1df502c33', 'BRANCH_MANAGER',
